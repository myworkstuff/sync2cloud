...
async function process_data(salestype,Array_barcode){    
    ...
    let Arr_CKSR = ['SLDO','BDS','DGO','KHM','KNG','M88','MGT','MLN','PPR','PR2','PTS','SJT','SPG','TLP','TRN','SBBK','SRGD','STLB','SLMW','SPRS','STPP'];
    let Arr_CKSM = ['GBVL','GDGO','GDMP','GHTP','GINN','GINT','GKBT','GKMS','GKPP','GLTJ','GPLC','GPPR','GPTG','GT2A','GTWR'];
    try {
