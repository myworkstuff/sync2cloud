...
async function process_data(salestype,Array_barcode){    
    ...
    try {
        ...
        await SendEmail("<table style='border: 1px solid black; border-collapse: collapse;width:100%;'>"+htmls_hdr+htmls+"</table>",salestype);
    } catch (error) {        
