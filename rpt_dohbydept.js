...
async function process_data_dept(periodcode){
    ...
    try {
        ...
        destinationConnection = await dbpool2.getConnection();            
        await destinationConnection.beginTransaction();  
        let query="SELECT location,periodcode,a.dept,b.description, ";
        ...
        query+="WHERE periodcode ='"+periodcode+"' ";
        query+="GROUP BY location,periodcode,a.dept ";  
...
async function process_sales(){
    ...
    for (let month = 1; month <= 12; month++) {
        ...
        await process_data_dept(periodcode);
        // await process_data_cat(periodcode);
        // await process_getDOH(periodcode);
    }
    process.exit();
}
process_sales();
